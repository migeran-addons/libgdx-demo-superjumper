...
@ObjCClassName("SuperJumperIOS")
public class SuperJumperIOS extends NSObject implements UIApplicationDelegate {
	...
	public boolean applicationDidFinishLaunchingWithOptions(
		...
		this.app = new IOSApplication(new SuperJumper(), config);
	...
	public static void main(String[] args) {
		UIKit.UIApplicationMain(0, null, null,
				SuperJumperIOS.class.getSimpleName());
	}
	
	@Selector("init")
	public SuperJumperIOS init() {
		super.init();
		return this;
	}
	...
	@Generated("NatJ")
	@Selector("alloc")
	public static native SuperJumperIOS alloc();

	@Generated("NatJ")
	protected SuperJumperIOS(Pointer peer) {
		super(peer);
	}
